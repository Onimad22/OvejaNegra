...
namespace OvejaNegra.Controllers
{
    ...
    public class CierresController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            var bono = _context.Pedidos.Where(c => c.Fecha.Date == fechaHoy.Date);
            ...
            if (_context.SueldosPago.FirstOrDefault(f => f.Fecha.Date == fechaHoy) != null)
            {
            ...
            cierre.Bono = bono.Sum(p => p.BonoT);
